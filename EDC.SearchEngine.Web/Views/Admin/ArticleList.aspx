<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArticleList.aspx.cs" Inherits="EDC.SearchEngine.Web.Admin.ArticleList" %>
    ...
    <form id="mainForm" runat="server">
        <div align="center">
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"
                DataObjectTypeName="EDC.SearchEngine.Model.Article" DeleteMethod="Delete"
                InsertMethod="Add" OldValuesParameterFormatString="original_{0}"
                SelectMethod="GetAll" TypeName="EDC.SearchEngine.Service.ArticleService"
